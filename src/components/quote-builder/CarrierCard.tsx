...
export function CarrierCard({ carrier, selected, isBestPrice, isBestMargin, tierLabel, onClick }: Props) {
  ...
  // Prefer validity_days when the policy supplies it (vendor-sourced rates
  // often use 7d). Fall back to the absolute validity_date.
      ...
      <div className="carrier-header">
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            ...
            {carrier.incoterm && (
              <Badge variant="gray" dot={false}>{carrier.incoterm}</Badge>
            )}
